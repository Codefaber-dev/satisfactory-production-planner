...
- Full Satisfactory v1.0 endgame and Update 6 content now available in the planner
...
- 🗄️ All Satisfactory v1.0 endgame and Update 6 content was already in the game but missing from the planner's database. This update backports it all.
